    ...
    <section id="libres" class ="parallax">
        ...
        float: none;">
                        <div id="search_container" class = "search_container gray_dark">
                            <h3 class = "section_body_content white" style="margin-top:0">Busca una simcard</h3>
                                <input class = "data white white_input" type="number" placeholder = "ICC / Teléfono" id = "dato_buscar_sim_libre" style="background:none;font-size:18px;text-align:center;padding:0" />
                            <div style="margin:auto">
