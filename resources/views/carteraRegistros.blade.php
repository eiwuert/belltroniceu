...
<div class="registro" id ="{{$registro['id']}}">
    ...
    <div class="container_total red_soft"><input type="text" id="{{$registro['id']}}_total" class="center_vert" value="${{number_format($registro['total']*-1,0,".",",")}}" style="max-width:500px;width:150px"></input></div>
    @else
    ...
    <div class="container_total green_soft"><input type="text" id="{{$registro['id']}}_total" class="center_vert" value="${{number_format($registro['total'],0,".",",")}}" style="max-width:500px;width:150px"></input></div>
    @endif
