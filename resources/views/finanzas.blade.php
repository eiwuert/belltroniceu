...
<body id="page-top" class="index">
        ...
        <div class="container">
            <div class="row">
                <div class="col-lg-12 text-center">
                    ...
                    <h3 class="section-subheading text-muted" style="color:black;margin-bottom:20px">Observa las ganancias separadas en tus subdistribuidores.</h3>
                </div>
            </div>
            <div class="row text-center ">
                <div style="display: inline-block;vertical-align: middle;float: none;width:100%">
                    <div class="flex_container" style="width:100%">
                        @if($user->isAdmin)
                        <select class="selectpicker" data-width="40%" data-style="data" id ="subPicker_subdistri">
                        ...
                        @endif
                        <select class="selectpicker" data-width="20%%" data-style="data" id ="subPicker_periodo">
            ...
            <div class="row text-center" style="margin-top:20px">
                <div class="col-md-4" style="display: inline-block;vertical-align: middle;float: none;">
                    <div class = "valores_sub_container">
                        <h3 class="section-subheading text-muted" style="color:white;margin-bottom:20px">GANANCIAS</h3>
                        <div id = "valores_subs">
    ...
    <!-- SECCION FINANZAS SUBS  -->
    <section id="finanzas_subs" class="parallex">
        <div class="container">
            <div class="row">
                <div class="col-lg-12 text-center">
    ...
    <script src="js/finanzas/finanzas.charts.js"></script>
