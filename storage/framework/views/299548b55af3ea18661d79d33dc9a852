        ...
        <div class="container">
            ...
            <div class="collapse navbar-collapse" id="bs-example-navbar-collapse-1">
                <ul class="nav navbar-nav navbar-right">
                    ...
                    <li>
                        <a class="page-scroll" href="#portfolio">Mi Estado</a>
                    </li>
                    <li>
                        <a class="page-scroll" href="#about">Estado Subs</a>
                    </li>
                    <li>
        ...
        <div class="container">
            <div class="row">
                <div class="col-lg-12 text-center">
                    ...
                    <h3 class="section-subheading text-muted">Ingresa la ICC o el numero de telefono. Si ingresas los dos se buscará por ICC.</h3>
                </div>
            </div>
    ...
    float: none;">
                    <div id="search_container" class = "search_container">
                        <h3 class = "section_body_content white" style="margin-top:0">Busca una simcard</h3>
                            <input class = "data" type="number" placeholder = "ICC" id = "ICC" />
                            <input class = "data" type="number" placeholder = "Telefono" id = "telefono"/>
    ...
    float: none;">
                    <div class = "search_results_container" >
                        <div class ="gray" style="flex-grow:2" id="ICC-container">
                            <input class="center white" type="number" id = "ICC-resultado" placeholder="ICC"></input>
                        </div>
                        <div class ="gray" style="flex-grow:2" id="telefono-container">
                            <input class="center white" type="number" id = "telefono-resultado" placeholder="Teléfono"></input>
                        </div>
                        <div class ="gray" style="flex-grow:2" id="tipo-container">
                            <input class="center white" type="text" id = "tipo-resultado" placeholder="Tipo"></input>
                        </div>
                        <div class ="gray" style="flex-grow:2" id="distribuidor-container">
                            <button class="center white" id ="distribuidor-resultado" onClick="$('#modal-distribuidor').modal('show')" style="background:none;border:none;" >Distribuidor</button>
                        </div>
                        <div class ="gray" style="flex-grow:2" id="subdistribuidor-container">
                            <button class="center white" id ="subdistribuidor-resultado" onClick="$('#modal-subdistribuidor').modal('show')" style="background:none;border:none;">Subdistribuidor</button>
                        </div>
                        <div class ="gray" style="flex-grow:2" id="fecha_vencimiento-container">
                            <input class="center white" type="date" id = "fecha_vencimiento-resultado" placeholder="Vencimiento"></input>
                        </div>
                        <div class ="gray" style="flex-grow:2" id="fecha_activacion-container">
                            <input class="center white" type="date" id = "fecha_activacion-resultado" placeholder="Activación"></input>
