           ...
           if(data == -1){
                ...
                try{
                    ...
                    if(data[7] == false){
                        ...
                        html += '</br><label style="min-width:100px;width:100px;margin-right:40px">$'+addCommas(Math.floor(data[4]*0.13))+'</label><label style="min-width:100px;width:100px">$' + addCommas(Math.floor(data[5]*0.105)) + '</label>';
                    }
                    $('#proyecciones_container').html(html);
                }catch(e){
                    alert(e);
